...
ui <- list(
  dashboardPage(
    ...
    dashboardHeader(
      ...
      tags$li(
        class = "dropdown",
        boastUtils::surveyLink(name = "Variable_Selection")
      ),
      tags$li(
        class = "dropdown",
    ...
    dashboardBody(
      tabItems(
        ...
        tabItem(
          ...
          box(
            title = strong("Potential Predictors"),
            status = "primary",
            collapsible = TRUE,
            collapsed = FALSE,
            width = '100%',
            tags$ul(
              tags$li(strong("Agriculture: "), "percent of males involved in
                      agriculture as an occupation."),
              tags$li(strong("Examination: "), "percent of draftees receiving
                      the highest mark on army examinations."),
              tags$li(strong("Education: "), "percent of draftees with education
                      beyond primary schooling."),
              tags$li(strong("Catholic: "), "percent of individuals who identify
                      as being of the Catholic faith (as possed to other faiths)."),
              tags$li(strong("Infant Mortality: "), "percentage of children born
          ...
          tabsetPanel(
            ...
            tabPanel(
              ...
              br(),
              p("Examine the following plots and decide which predictors you would
        ...
        tabItem(
          ...
          p(
            class = "hangingindent",
            "Hocking, R. R. (1976), ols_mallows_cp: get Mallows' 
            Cp statistic with olsrr, R package. Available from 
          ...
          p(
            ...
            Available from https://cran.r-project.org/web/packages/leaps/index.html"
        ),
        p(
          class = "hangingindent",
          "Model Selection Criteria. Model Selection.[Text file].
             ...
             Available from 
            http://facweb.cs.depaul.edu/sjost/csc423/documents/model-selection.html"
          ),
        p(
          class = "hangingindent",
